              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog">
                    ...
                    <!-- End events slider -->
                    <h2 class="blog_title"><a href="blog-single.html">Tahukah Kamu?</a></h2>
                   
                    <p>
<font style="color: red;font-weight: bold;">Tahukah kamu?</font><br>
Sempoa tradisional memiliki 2 buah manik-manik di atas dan 5 buah manik-manik di bagian bawah. Metode ini mengikuti metode pengukuran perhitungan Cina kuno, yakni basis 16 digit (hexa-desimal). Bilangan basis 16 menggunakan 16  buah simbol, mulai dari 0 sampai 9, kemudian dilanjut dari A sampai F. Jadi, angka A sampai F merupakan simbol untuk 10 sampai 15. <br>
Sementara itu, sempoa modern hanya memiliki 1 buah manik-manik di bagian atas dan 4 buah manik-manik di bagian bawah. Hal ini karena mengikuti perhitungan basis 10 (desimal). Bilangan basis 10 menggunakan 10 angka mulai 0 sampai 9 secara berturut-turut. Setelah angka 9, maka angka berikutnya adalah 10, 11, 12 dan seterusnya. 
</p>
                  </div>
